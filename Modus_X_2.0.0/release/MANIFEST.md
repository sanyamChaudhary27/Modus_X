...
`Modus_X_2.0.0_release.zip.sha256` for the archive.

## Primary publication artifacts

| Artifact | Purpose | Status |
|---|---|---|
| `paper/Modus_X_2.0.0_whitepaper.pdf` | rendered research paper | generated during build |
| `Modus_X_2.0.0_release.zip` | source, evidence, docs, and paper | generated during build |
