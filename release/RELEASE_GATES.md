...
- [ ] Modus_X 80M dense audit raw JSON promoted.
- [ ] Official Mamba dense audit raw JSON promoted.
- [ ] Official xLSTM dense audit raw JSON promoted.
- [ ] Official Mamba standard recall `results.json` promoted.
...
- [x] Expanded paper is complete.
- [x] Every headline table is scoped to its evidence protocol.
- [x] Language modeling and associative memory are discussed separately.
- [x] Negative Mamba BPC result is reported.
