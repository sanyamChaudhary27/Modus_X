...
- Final source/evidence staging directory:
  `Modus_X_2.0.0/release_candidate/`.
...
The two checkpoint-preserving annealing continuations are intentionally
excluded from v2.0.0. They may enter v2.1.0 only after their compact archives,
configs, progress records, and dense audit JSON files are preserved. No claim
in this release depends on their outcome.
