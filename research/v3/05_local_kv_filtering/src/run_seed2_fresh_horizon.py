...
def main():
    ...
    if a.seed != 2 or a.resume:
        raise ValueError('This newly declared follow-up starts seed2 from scratch only.')
    ...
    report['followup_protocol']='seed2 fresh fixed25k horizon; declared after seed1 endpoint; 5k screen report-only; original failed screen preserved'
