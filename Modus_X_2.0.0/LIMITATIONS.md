...
11. **Single-seed scaling.** The 47M/81M/99M MemoryFeedback points are one seed
    each, and the 47M learning-rate schedule differs from the larger runs.
12. **Scale allocation.** The 99M point is not a self-similar enlargement:
    ...
    fixed at 32.
13. **Pending continuations.** The 122.88M-character anneal runs were still
    running during package preparation and are excluded from release claims.
