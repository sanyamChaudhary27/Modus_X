...
2. Import prior files only when they remain valid; remove superseded archives
   and PDFs.
3. Upload:
   - `Modus_X_2.0.0_whitepaper.pdf`;
   - `Modus_X_2.0.0_release.zip`;
   - optional compact raw-run archives listed in `MANIFEST.md`.
4. Use version `2.0.0`, resource type `Publication / Preprint`, publication
...
6. Reserved v2 DOI: `10.5281/zenodo.21538210`. Embed it in the final paper and
   citation metadata before upload.
