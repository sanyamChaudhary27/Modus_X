...
<body>
    ...
    <div class="title-container">
        ...
        <div class="authors">
            ...
            <span style="margin-top: 5px; display: inline-block; font-size: 9.5pt; font-family: 'JetBrains Mono', monospace;"><a href="https://doi.org/{os.environ.get('MODUS_X_DOI', '10.5281/zenodo.21538210')}" style="color: #4a5568; text-decoration: none; border-bottom: 1px solid #cbd5e1;">{os.environ.get('MODUS_X_DOI', '10.5281/zenodo.21538210')}</a> &nbsp;|&nbsp; <a href="https://github.com/sanyamChaudhary27/Modus_X" style="color: #4a5568; text-decoration: none; border-bottom: 1px solid #cbd5e1;">github.com/sanyamChaudhary27/Modus_X</a></span>
        </div>
    </div>
    <!-- Centered Abstract -->
...
"""
    ...
    abs_pdf_path = os.path.join(base_dir, "Modus_X_2.0.0_whitepaper.pdf")
