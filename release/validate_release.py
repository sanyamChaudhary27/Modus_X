...
REQUIRED = [
    ...
    "paper/whitepaper.md",
    "paper/build_pdf.py",
    "figures/modus_x_v2_1_architecture.png",
    ...
    "evidence/language/scaling/memory_feedback_81m_anneal_point.json",
    "evidence/language/scaling/memory_feedback_99m_anneal_point.json",
    "evidence/language/scaling/memory_feedback_81m_matched_endpoint.json",
    "evidence/language/scaling/memory_feedback_scaling.png",
    "evidence/language/scaling/memory_feedback_matched_endpoint.png",
...
def main() -> None:
    ...
    if metadata.get("version") != "2.1.0":
        raise SystemExit(".zenodo.json must declare version 2.1.0")
    if (
    ...
    endpoint_observed = (
        endpoint["params"],
        endpoint["processed_characters"],
        endpoint["optimizer_steps"],
        endpoint["dense_validation_bpc"],
        endpoint["dense_test_bpc"],
    )
    endpoint_expected = (
        81_486_728,
        163_840_000,
    ...
    if endpoint_observed != endpoint_expected:
        raise SystemExit(
            f"Matched endpoint evidence mismatch: {endpoint_observed}"
        )
